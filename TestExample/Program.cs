...
string blueOnCyan = Color.Blue.GetForegroundEscapeCode() + Color.Red.GetBackgroundEscapeCode();
string reset = "\u001b[0m";
string blueOnCyanHelloWorld = $"{blueOnCyan}{helloWorld}{reset}";

Console.WriteLine(blueOnCyanHelloWorld);
//var ui = new GiftUI();
