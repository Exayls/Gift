...
namespace Gift.Domain.Tests.Display
{
    public class ScreenDisplayTest
    {
        ...
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 10), emptychar: '@');
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(1, 6), emptychar: '*');
            // act
        ...
        public void AddDisplay_should_display_2nd_screen_over_when_add_screen3()
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 10), emptychar: ' ');
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(1, 6), emptychar: 'p');
            // act
            screen.AddDisplay(screenToAdd, new Position(1, 0));
            // assert
        ...
        public void AddDisplay_should_display_partof_2nd_screen_over_when_add_screen_offscreen6()
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 10), emptychar: '@');
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(2, 6), emptychar: '*');
            // act
        ...
        public void AddDisplay_should_display_2nd_screen_over_when_2nd_screen_Bigger()
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 10), emptychar: '@');
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(4, 14), emptychar: '*');
            // act
        ...
        public void AddDisplay_should_display_2nd_screen_over_when_2nd_screen_Same_size1()
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 10), emptychar: '@');
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(1, 10), emptychar: '*');
            // act
        ...
        public void AddDisplay_should_display_2nd_screen_over_when_2nd_screen_Same_size2()
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 10), emptychar: '@');
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(3, 10), emptychar: '*');
            // act
            screen.AddDisplay(screenToAdd, new Position(0, 0));
            // assert
            char[,] expectedDisplay = Convert_string_to_char(["**********", "**********", "**********"]);
        ...
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(2, 3), emptychar: '@');
            // act
        ...
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 3), emptychar: '@');
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(1, 2), backColor: Color.Red, emptychar: '*');
            ScreenDisplay screenToAdd2 = new ScreenDisplay(new Size(1, 1), backColor: Color.Green, emptychar: ' ');
            // act
        ...
        {
            // arrange
            ScreenDisplay screen = new ScreenDisplay(new Size(3, 3), emptychar: '@', backColor: Color.Black);
            ScreenDisplay screenToAdd = new ScreenDisplay(new Size(1, 2), backColor: Color.Red, emptychar: '*');
            // act
            screen.AddDisplay(screenToAdd, new Position(1, 0));
            // assert
